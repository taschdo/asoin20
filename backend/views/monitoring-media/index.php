...
<div class="study-index">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">Лента новостей - <i>картина дня</i></h3>
                            <div class="pull-right box-tools with-border">
                                <?= \Yii::$app->user->can('monitoring-media/control') ? Html::a('<span class="glyphicon glyphicon-wrench"></span>', ['control'], ['class' => 'btn btn-success btn-sm', 'title' => 'Администраторская часть']) : '' ?>
